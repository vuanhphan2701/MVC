...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo href('product', 'add') ?>" class="add-product-btn">
                                ...
                                <td data-label="Actions">
                                    <div class="action-buttons">
                                        <a class="btn btn-primary btn-sm action-button" 
                                           role="button" 
                                           href="<?php echo href('product', 'restore') ?>&id=<?php echo $item->getId() ?>"
...
<script>
    ...
    function confirmDelete(id, name) {
        if (confirm(`Are you sure you want to permanently delete "${name}"? This action cannot be undone.`)) {
            window.location.href = `<?php echo href('product', 'deletePermanently') ?>&id=${id}`;
        }
    }

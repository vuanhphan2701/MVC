                ...
                foreach ($lists as $item) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick=" return confirm('Are you sure to delete this book ?')" class="btn btn-danger" role="button" href="<?php echo href('product', 'delete') ?>&id=<?php echo $item->getId() ?>"><i class="fa fa-trash search-icon"></i></a>
